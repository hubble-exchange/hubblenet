...
func getShortOrder() LimitOrder {
	...
	shortOrder, _ := createLimitOrder(uint64(1), "short", "0x22Bb736b64A0b4D4081E103f83bccF864F0404aa", big.NewInt(-10), big.NewInt(20.0), Placed, signature, big.NewInt(2), salt)
	return shortOrder
}
...
func getLongOrder() LimitOrder {
	...
	salt := big.NewInt(time.Now().Unix())
	longOrder, _ := createLimitOrder(uint64(1), "long", "0x22Bb736b64A0b4D4081E103f83bccF864F0404aa", big.NewInt(10), big.NewInt(20.0), Placed, signature, big.NewInt(2), salt)
	return longOrder
}
