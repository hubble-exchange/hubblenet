...
func calcMarginFraction(trader *Trader, pendingFunding *big.Int, marginMode MarginMode, oraclePrices map[Market]*big.Int, lastPrices map[Market]*big.Int) *big.Int {
