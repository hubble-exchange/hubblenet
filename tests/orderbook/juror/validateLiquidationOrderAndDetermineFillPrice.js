...
describe("Testing validateLiquidationOrderAndDetermineFillPrice",async function () {
    ...
    context("when liquidation amount is > zero", async function () {
        context("when order is not encoded properly", async function () {
            it("returns error", async function () {
                ...
                try {
                    ...
                    error_message = JSON.parse(error.error.body).error.message
                    expect(error_message).to.equal("abi: attempting to unmarshall an empty string while arguments are expected")
                    return
                }
                expect.fail("Expected throw not received");
            })
        ...
        context("when order is encoded properly", async function () {
            context("when order is invalid", async function () {
                it("returns error when order was never placed", async function () {
                    ...
                    // try long order
                    try {
                        await juror.validateLiquidationOrderAndDetermineFillPrice(encodeLimitOrder(longOrder), liquidationAmount)
                    } catch (error) {
                        error_message = JSON.parse(error.error.body).error.message
                    ...
                    try {
                        await juror.validateLiquidationOrderAndDetermineFillPrice(encodeLimitOrder(shortOrder), liquidationAmount)
                    } catch (error) {
                        error_message = JSON.parse(error.error.body).error.message
                        expect(error_message).to.equal("invalid order")
                        return
                    ...
                    context("when order's filled amount + liquidationAmount is <= order's baseAssetQuantity", async function () {
                        ...
                        context("When liquidation amount is not multiple of minSizeRequirement", async function () {
                            ...
                            it("returns error if liquidationAmount is greater than minSizeRequirement but not a multiple", async function () {
                                ...
                                // try long order
                                try {
                                    response = await juror.validateLiquidationOrderAndDetermineFillPrice(encodeLimitOrder(longOrder), liquidationAmount)
                                } catch (error) {
                                    error_message = JSON.parse(error.error.body).error.message
                                    expect(error_message).to.equal("not multiple")
                                }
                ...
                context("When liquidationAmount is valid", async function () {
                    context("For a long order", async function () {
                        ...
                        it("returns upperBound as fillPrice is price is more than upperBound", async function () {
                            ...
                            responseLongOrder1 =  await juror.validateLiquidationOrderAndDetermineFillPrice(encodeLimitOrder(longOrder1), liquidationAmount)
                            ...
                            responseLongOrder2 = await juror.validateLiquidationOrderAndDetermineFillPrice(encodeLimitOrder(longOrder2), liquidationAmount)
                            ...
                            responseLongOrder3 = await juror.validateLiquidationOrderAndDetermineFillPrice(encodeLimitOrder(longOrder3), liquidationAmount)
                    ...
                    context("For a short order", async function () {
                        it("returns lower bound as fillPrice if shortPrice is less than lowerBound", async function () {
                            ...
                            responseShortOrder1 = await juror.validateLiquidationOrderAndDetermineFillPrice(encodeLimitOrder(shortOrder1), liquidationAmount)
                            ...
                            responseShortOrder2 = await juror.validateLiquidationOrderAndDetermineFillPrice(encodeLimitOrder(shortOrder2), liquidationAmount)
                            ...
                            responseShortOrder3 = await juror.validateLiquidationOrderAndDetermineFillPrice(encodeLimitOrder(shortOrder3), liquidationAmount)
