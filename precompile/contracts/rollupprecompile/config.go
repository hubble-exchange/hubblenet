...
// adds specific configuration for OrderBookRollupPrecompile.
type Config struct {
...
// that disables OrderBookRollupPrecompile.
...
// Key returns the key for the OrderBookRollupPrecompile precompileconfig.
